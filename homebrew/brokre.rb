class Brokre < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.1.30/brokre-x86_64-apple-darwin.tar.gz"
    sha256 "00541f0413bf8403d0be47f71ee65ec21c3cc4ac06845507cda244da7e9ac8ab"
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.1.30/brokre-aarch64-apple-darwin.tar.gz"
    sha256 "8e0540ba5445127034e7933ccc3c35ace3a5a43785997936764bbe022b9c7aa3"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.1.30/brokre-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "ef6f2030dc9dde6c861527ba89d88a9e18b40407d94cd1700db321afca46bffc"
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.1.30/brokre-aarch64-unknown-linux-gnu.tar.gz"
