class Brokre < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.0/brokre-x86_64-apple-darwin.tar.gz"
    sha256 "a7e70923851562dc44d925c2430836be23886d666cb4830e13a2b37a594d7dc3"
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.0/brokre-aarch64-apple-darwin.tar.gz"
    sha256 "902495de9617a68a29ffa0090c56668118c861d813cc4ffcb2dc39463491c439"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.0/brokre-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "a4b4c57d577e5b72a780a9faf6adba9eb9135cbe2f2aa7d33e396defcc5831d9"
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.0/brokre-aarch64-unknown-linux-gnu.tar.gz"
