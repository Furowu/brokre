class Brokre < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.18/brokre-x86_64-apple-darwin.tar.gz"
    sha256 "5190bf6c97873a2e054d2245e2a04ef067a12d40fc1e8d55dbbb3944af3b2b67"
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.18/brokre-aarch64-apple-darwin.tar.gz"
    sha256 "0c6f44c1048e7148aacd05fad56ac19aa2bbe2266f139a407406b70c554ad299"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.18/brokre-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "8c4afffbfd7208f9867a9d029cb22801550a9d6b7f810f181b578c3a3fb5f65a"
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/Furowu/brokre/releases/download/v0.2.18/brokre-aarch64-unknown-linux-gnu.tar.gz"
